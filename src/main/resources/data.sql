...
VALUES
    ...
    ('GUEST', 2, 'Dragan', 'Draganić', 'dragan@gmail.com', '$2a$12$KmFHBhd8NSsRcA7ThwY6eOMTru7w/RQqoCXoWFQmxpUvyrUu0pAWy', '(+381)69774829', 'Bulevar vojvode Mišića 64', 'Beograd', 'Serbia', 'profile.png', null, '2023-08-11 13:00:00', true, true, true, null, null, null),
...
VALUES
    (1, 1, 7, 2, 520.0 * 2 * 2, '2023-12-22', null, '2023-12-22', '2023-12-23'),
    (1, 2, 7, 2, 430.0 * 4 * 2, '2023-12-22', null, '2023-12-26', '2023-12-30'),
    (1, 3, 7, 3, 300.0 * 5 * 3, '2023-12-24', '2023-12-26', '2024-01-13', '2024-01-18'),
    (1, 4, 7, 2, 150.0 * 6, '2023-12-25', null, '2023-12-25', '2024-01-20'),
    (1, 5, 7, 3, 450.0 * 4 * 10, '2023-12-27', null, '2023-03-11', '2023-03-15'),
