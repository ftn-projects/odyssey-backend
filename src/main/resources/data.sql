...
VALUES
    ('USER', 1, 'marko', 'Marko', 'Marković', 'admin@gmail.com', '', '(+381)69423143', 'Bulevar cara Dušana 34', 'Novi Sad', 'Serbia', 'profile.png', null, '2023-01-01 11:00:00', null, null, null, null, true, true),
    ('HOST', 1, 'petar', 'Petar', 'Petrović', 'petar@gmail.com', '', '(+381)63748021', 'Slobodana Jovanovića 8', 'Kruševac', 'Serbia', 'profile.png', 'Živim u Kruševcu i izdajem 2 smeštaja.', '2023-02-10 12:00:00', true, null, null, true, true, true),
    ('HOST', 1, 'nevena', 'Nevena', 'Nevenić', 'nevena@gmail.com', '', '(+381)65900314', 'Jovana Ristića 87', 'Niš', 'Serbia', 'profile.png', 'Iz Niš sam i izdajem 3 apartmana.', '2023-03-21 10:00:00', true, null, null, true, true, true),
    ('HOST', 2, 'milica', 'Milica', 'Milić', 'milica@gmail.com', '', '(+381)63984039', 'Bulevar vojvode Mišića 74', 'Beograd', 'Serbia', 'profile.png', 'Živim u Beogradu i posedujem nekoliko smeštaja.', '2023-06-08 09:00:00', true, null, null, true, true, true),
    ('GUEST', 1, 'dragan', 'Dragan', 'Draganić', 'dragan@gmail.com', '', '(+381)69774829', 'Bulevar vojvode Mišića 64', 'Beograd', 'Serbia', 'profile.png', null, '2023-08-11 13:00:00', true, true, true, null, null, null),
    ('GUEST', 3, 'marija', 'Marija', 'Marijanović', 'marija@gmail.com', '', '(+381)63756640', 'Stražilovska 3', 'Novi Sad', 'Serbia', 'profile.png', null, '2021-09-17 15:00:00', true, true, true, null, null, null),
    ('GUEST', 1, 'milos', 'Miloš', 'Milošević', 'milos@gmail.com', '', '(+381)651859940', 'Svetozara Radojčića 17', 'Beograd', 'Serbia', 'profile.png', null, '2023-10-29 20:00:00', true, true, true, null, null, null),
    ('GUEST', 0, 'novi', 'Novi', 'Nalog', 'novi@gmail.com', '', '(+381)0000000', 'Neka Ulica 99', 'Beograd', 'Serbia', 'profile.png', null, '2023-12-21 08:00:00', true, true, true, null, null, null),
    ('USER', 1, 'trent', 'Trent', 'Trentović', 'superadmin@gmail.com', '', '(+381)647388291', 'Bulevar Oslobođenja 43', 'Novi Sad', 'Serbia', 'profile.png', null, '2023-01-01 08:00:00', null, null, null, null, true, true);
